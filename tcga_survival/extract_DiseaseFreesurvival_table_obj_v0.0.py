    ...
    for infile in infiles:
        ...
        for row in infile_reader:    
            ...
            if row_ID=="patient.days_to_death":
                death_list=row
                complete+=1
            if row_ID=="patient.person_neoplasm_cancer_status":
                status_list=row
                complete+=1
            if complete==3:
                for index in range(patient_count):
                    ...
                    survival_day = follow_up_list[index]
                    end_day = death_list[index]
                    if status!="NA":
                        if survival_day=="NA":
                            day=end_day
                        if end_day=="NA":
        ...
        for row in infile_reader:    
            ...
            if row_ID=="patient.follow_ups.follow_up.days_to_death":
                death_list=row
                complete+=1
            if row_ID=="patient.follow_ups.follow_up.person_neoplasm_cancer_status":
                status_list=row
                complete+=1
            if complete==3:
                for index in range(patient_count):
        ...
        for row in infile_reader:    
            ...
            if row_ID=="patient.follow_ups.follow_up-2.days_to_death":
                death_list=row
                complete+=1
            if row_ID=="patient.follow_ups.follow_up-2.person_neoplasm_cancer_status":
                status_list=row
                complete+=1
            if complete==3:
                for index in range(patient_count):
        ...
        for row in infile_reader:    
            ...
            if row_ID=="patient.follow_ups.follow_up-3.days_to_death":
                death_list=row
                complete+=1
            if row_ID=="patient.follow_ups.follow_up-3.person_neoplasm_cancer_status":
                status_list=row
                complete+=1
            if complete==3:
                for index in range(patient_count):
        ...
        for row in infile_reader:    
            ...
            if row_ID=="patient.follow_ups.follow_up-4.days_to_death":
                death_list=row
                complete+=1
            if row_ID=="patient.follow_ups.follow_up-4.person_neoplasm_cancer_status":
                status_list=row
                complete+=1
            if complete==3:
                for index in range(patient_count):
        ...
        for row in infile_reader:    
            ...
            if row_ID=="patient.follow_ups.follow_up-5.days_to_death":
                death_list=row
                complete+=1
            if row_ID=="patient.follow_ups.follow_up-5.person_neoplasm_cancer_status":
                status_list=row
                complete+=1
            if complete==3:
                for index in range(patient_count):
...
if __name__ == "__main__":
    ...
    prefix="DiseaseFree_survival_table"
    OUTPUT_SUFFIX="txt"
